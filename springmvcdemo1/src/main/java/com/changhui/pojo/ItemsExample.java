...
public class ItemsExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public String toString() {
            final StringBuilder sb = new StringBuilder("GeneratedCriteria [");
    ...
    public static class Criterion {
        ...
        public String toString() {
            ...
            sb.append(", betweenValue=").append(betweenValue);
    ...
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("ItemsExample [");
